...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "msmaven@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "msmaven API";

        private String description = "msmaven API documentation";
